 ...
 */
// TODO: DO NO USE for now. Camera will stuck on top or bottom. Probably due to rounding? 
...
public class CameraLookController : MonoBehaviour
{
    ...
    private void Awake()
    {
        playerInput = InputManager.Instance.playerInput; //new PlayerInputActions();
